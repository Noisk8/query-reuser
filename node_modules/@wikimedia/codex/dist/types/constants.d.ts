...
export declare const StatusTypes: readonly ["subtle", "notice", "progressive", "warning", "error", "success"];
export declare const statusTypeValidator: import("./types").StringTypeValidator<"progressive" | "subtle" | "notice" | "warning" | "error" | "success">;
 ...
 */
export declare const AccordionSeparations: readonly ["none", "minimal", "divider", "outline"];
/**
