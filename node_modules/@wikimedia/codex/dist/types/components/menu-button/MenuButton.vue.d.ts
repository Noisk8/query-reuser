...
import { MenuButtonItemData, MenuGroupData, MenuConfig, MenuItemData, MenuItemValue, ButtonAction, ButtonWeight } from '../../types';
declare const _default: import("vue").DefineComponent<import("vue").ExtractPropTypes<{
    ...
    menuId: string;
    modelWrapper: import("vue").WritableComputedRef<MenuItemValue | MenuItemValue[] | null, MenuItemValue | MenuItemValue[] | null>;
    onKeydown: (e: KeyboardEvent) => void;
    onClick: () => void;
    onBlur: () => void;
    button: Ref<import("vue").CreateComponentPublicInstanceWithMixins<Readonly<import("vue").ExtractPropTypes<{
        action: {
            type: PropType<ButtonAction>;
            default: string;
