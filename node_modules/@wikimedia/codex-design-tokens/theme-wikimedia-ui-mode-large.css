...
:root {
  --font-size-x-small: 0.875rem; /* `x` stands for extra. In this case extra small. */
  ...
  --line-height-x-small: 1.375rem; /* `x` stands for extra. In this case extra small. */
  ...
  --line-height-content: 1.55; /* Intended for user-generated content that comes from outside of the design system. Components and features should use the standard font-size and line-height tokens instead. */
}
